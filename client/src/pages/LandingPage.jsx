      ...
      <div className="landingHero">
        <div className="landingHero-title">
          <h1 className="banner-h1">
            Jet Set, Go! Your Perfect Flight Awaits.
          </h1>
          <p className="banner-p">
            Ignite your wanderlust and embark on unforgettable journeys with
            ease, booking extraordinary flights that take you to the world's
